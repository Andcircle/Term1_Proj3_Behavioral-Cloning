...
csv_file='./data/driving_log2.csv'
...
csv_file='./Li_Data/driving_log.csv'
...
csv_file='./Li_Data2/driving_log.csv'
...
model.save('./nv/model_lz_nv0_v2.h5')
model.save_weights('./nv/weights_lz_nv0_v2.h5')
